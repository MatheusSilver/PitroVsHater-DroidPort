...
class OptionsMenu extends MusicBeatState
{
	...
	var options:Array<OptionCategory> = [
		new OptionCategory("Gameplay", [
			...
			#end
			new AccuracyDOption("Muda como a precisão é calculada. (Preciso = Simple, Complexo = Milisecond Based)")
		]),
		new OptionCategory("Aparencia", [
			new RainbowFPSOption("Faz seu FPS parecer uma bandeira Gay"),
			new AccuracyOption("Esconde ou não, informações sobre precisão"),
			new NPSDisplayOption("Te mostra a quantidade de notas por segundo vindo ai"),
			new SongPositionOption("Mostra sua atual posição na musica (como uma barra)"),

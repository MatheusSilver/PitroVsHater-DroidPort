...
class CustomControlsState extends MusicBeatSubstate
{
	...
	var rightArrow:FlxSprite;
							//'hitbox',
	var controlitems:Array<String> = ['Controle Destro', 'Controle Canhoto','tecladin','customizado', 'hitbox'];
	...
	public function new()
	{
		...
		exportbutton = new FlxUIButton(FlxG.width - 150, 25, "Exporatr", () -> { savetoclipboard(_pad); } );
